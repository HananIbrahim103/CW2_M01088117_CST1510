...
def register_user(username, role, password):
    ...
    with open(r"C:\Users\Hanan\OneDrive\Documents\programming\CW2_M01088117_CST1510\DATA\users.txt", "a") as file:
...
def user_exists(username):
    try:
        ...
        with open(r"C:\Users\Hanan\OneDrive\Documents\programming\CW2_M01088117_CST1510\DATA\users.txt", "a") as f:
            f.write(" ")
            pass
...
def login_user(username, password):
    with open(r"C:\Users\Hanan\OneDrive\Documents\programming\CW2_M01088117_CST1510\DATA\users.txt", "r") as f:
        for line in f.readlines():
